...
class IdEngineSession(
    ...
    companion object{
        val passportDataChecks = arrayOf("check_4000000000001", "check_4000000000002", "check_4000000000003");
    }
    ...
    //                        Log.w(TAG,"image buffer converted to bitmap: ${bitmap.width}x${bitmap.height}")
                        ...
                        // Other fields
                        val otherFieldsDictionary = mapOf(
                            "COM" to "rfid_com",
                            "SOD" to "rfid_sod",
                            "DG1" to "rfid_dg1",
                            "DG2" to "rfid_dg2",
                        ...
                        passportData.otherFields.forEach {(key,value)->
                            otherFieldsDictionary[key]?.let { name ->
                                put( name, JSONObject()
                                    .put("value", value)
                                    .put("type", "String")
                                )
