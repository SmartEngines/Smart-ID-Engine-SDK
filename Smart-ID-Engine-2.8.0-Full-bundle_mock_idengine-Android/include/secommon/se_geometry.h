...
/// QuadranglesVectorIterator internal implementation forward declaration
class QuadranglesVectorIteratorImpl;


/**
 * @brief QuadranglesVectorIterator: iterator object for vector of quadrangles
 */
class SE_DLL_EXPORT QuadranglesVectorIterator {
private:
...
public:
  ...
  static QuadranglesVectorIterator ConstructFromImpl(
    const QuadranglesVectorIteratorImpl& pimpl);
...
private:
  class QuadranglesVectorIteratorImpl* pimpl_; ///< Internal implementation
};
