...
- (void) smartIDVauthViewControllerDidGalleryPick;

- (void) smartIDVauthViewControllerDidPhotoPick:(nonnull UIImage *)photo;

- (void) smartIDVauthViewControllerDidReceiveBuffer:(nullable CMSampleBufferRef)buffer;
