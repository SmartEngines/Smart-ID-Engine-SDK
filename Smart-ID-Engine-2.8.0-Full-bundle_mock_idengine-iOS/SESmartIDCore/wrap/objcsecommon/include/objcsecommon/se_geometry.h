...
@interface SECommonQuadranglesVectorIterator : NSObject

- (nonnull instancetype) initWithOther:(nonnull SECommonQuadranglesVectorIterator *)other;
- (BOOL) isEqualToIter:(nonnull SECommonQuadranglesVectorIterator *)other;
