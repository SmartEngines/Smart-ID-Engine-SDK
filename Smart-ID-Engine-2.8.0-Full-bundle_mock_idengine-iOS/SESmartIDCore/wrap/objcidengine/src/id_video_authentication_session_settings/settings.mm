...
@implementation SEIdVideoAuthenticationSessionSettings {
  std::unique_ptr<se::id::IdVideoAuthenticationSessionSettings> internal;
}
...
- (instancetype) initFromOther:(SEIdVideoAuthenticationSessionSettings *)other {
  if (self = [super init]) {
    internal.reset([other getInternalVideoAuthenticationSessionSettings].Clone());
  }
  return self;
}
