...
/**
 * @file se_common.h
 * @brief Include all interface headers of secommon library
 */


#ifndef SECOMMON_SE_COMMON_H_INCLUDED
#define SECOMMON_SE_COMMON_H_INCLUDED
...
#endif // SECOMMON_SE_COMMON_H_INCLUDED
