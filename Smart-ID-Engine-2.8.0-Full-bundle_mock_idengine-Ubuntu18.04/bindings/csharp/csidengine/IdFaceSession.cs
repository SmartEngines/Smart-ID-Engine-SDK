...
public class IdFaceSession : global::System.IDisposable {
  ...
  public virtual void SetFaceToMatchWith(Image face_image) {
    csidenginePINVOKE.IdFaceSession_SetFaceToMatchWith(swigCPtr, Image.getCPtr(face_image));
    if (csidenginePINVOKE.SWIGPendingException.Pending) throw csidenginePINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public virtual uint GetInstructionsCount() {
    uint ret = csidenginePINVOKE.IdFaceSession_GetInstructionsCount(swigCPtr);
    if (csidenginePINVOKE.SWIGPendingException.Pending) throw csidenginePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual uint GetPushedImagesCount() {
    uint ret = csidenginePINVOKE.IdFaceSession_GetPushedImagesCount(swigCPtr);
    if (csidenginePINVOKE.SWIGPendingException.Pending) throw csidenginePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual uint GetAllowedNumberOfFailedInstructions() {
    uint ret = csidenginePINVOKE.IdFaceSession_GetAllowedNumberOfFailedInstructions(swigCPtr);
    if (csidenginePINVOKE.SWIGPendingException.Pending) throw csidenginePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual uint GetInitializerInstructionTime() {
    uint ret = csidenginePINVOKE.IdFaceSession_GetInitializerInstructionTime(swigCPtr);
    if (csidenginePINVOKE.SWIGPendingException.Pending) throw csidenginePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual uint GetPassAllInstruction() {
    uint ret = csidenginePINVOKE.IdFaceSession_GetPassAllInstruction(swigCPtr);
    if (csidenginePINVOKE.SWIGPendingException.Pending) throw csidenginePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
