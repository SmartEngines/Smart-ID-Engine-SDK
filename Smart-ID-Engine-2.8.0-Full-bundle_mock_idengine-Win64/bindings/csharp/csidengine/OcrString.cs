...
public class OcrString : global::System.IDisposable {
  ...
  public bool GetAcceptFlag() {
    bool ret = cssecommonPINVOKE.OcrString_GetAcceptFlag(swigCPtr);
    if (cssecommonPINVOKE.SWIGPendingException.Pending) throw cssecommonPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool GetCellAcceptFlagByIndex(int idx) {
    bool ret = cssecommonPINVOKE.OcrString_GetCellAcceptFlagByIndex(swigCPtr, idx);
    if (cssecommonPINVOKE.SWIGPendingException.Pending) throw cssecommonPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public OcrPair GetPairTable() {
    global::System.IntPtr cPtr = cssecommonPINVOKE.OcrString_GetPairTable(swigCPtr);
    OcrPair ret = (cPtr == global::System.IntPtr.Zero) ? null : new OcrPair(cPtr, false);
    if (cssecommonPINVOKE.SWIGPendingException.Pending) throw cssecommonPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
