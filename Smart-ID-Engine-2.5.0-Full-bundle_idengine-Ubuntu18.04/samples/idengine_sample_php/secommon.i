...
%nodefaultctor se::common::Image;
%nodefaultctor se::common::ProjectiveTransform;
%nodefaultctor se::common::Serializer;
%nodefaultctor se::common::StringsSet;

%nodefaultctor se::common::QuadranglesMapIterator;
%nodefaultctor se::common::StringsVectorIterator;
%nodefaultctor se::common::StringsSetIterator;
%nodefaultctor se::common::StringsMapIterator;
...
%newobject se::common::Serializer::CreateJSONSerializer;
